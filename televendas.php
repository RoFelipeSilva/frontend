...
<section class="row" id="menu">
  ...
  <br>
           <p class="col-sm-12"> Nossa empresa possui o serviço de tele vendas, aonde você que é empresário possa fazer seu pedido ou sugerir um orçamento dos produtos que deseja para compor seu estoque.</em> </p>
           <div class="col-sm-12">
          <p class="col-sm-12"> Deixe seu contato que nossos vendedores irá atende-lo o mais breve possível.
          <article class="col-12">
          <h2 id="formulario">Contato</h2>
         <form action="#" method="post" id="needs-validation" novalidate>
         <div class="form-group row">
         <label for="nome" class="col-sm-2 col-form-label col-form-label-sm">Telefone*</label>
         <div class="col-sm-10">
         <input type="text" class="form-control form-control-sm" id="nome" placeholder="digite seu contato" required>
 ...
 * Campos obrigatórios.
 ...
 <p class="col-sm-12"> Contato: (18) 99648-5768 (whatsApp)</em> </p>
    <div class="col-sm-12">
    <p class="col-sm-12"> E-mail: variedadesonlinepp@gmail.com
   </small>
    </div>
    </form>
    </article>
