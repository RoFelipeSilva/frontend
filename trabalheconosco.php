...
<section class="row" id="menu">
 ...
 <div class="form-group row">
    ...
    <div class="col-sm-10">
    <input type="email" class="form-control form-control-sm" id="contato" placeholder="Envie seu contato"
   required>
    ...
    <div class="form-group row">
    <label for="mensagem" class="col-sm-2 col-form-label col-form-label-sm">Currículo*</label>
    <div class="col-sm-10">
 <textarea class="form-control form-control-sm" id="contato" placeholder="Envie seu currículo" required></textarea>  
